  ...
  int selSob = 0;
	...
	if(selSob == 1){
		...
		gaInc.populationSize(popsize);
	  	...
	  	promedioResultados << "    PORCENTAJE :" << porcentajeTotal<< "\n";
	  	promedioResultados << "    NUMERO DE REGLAS : " <<  numReglasTotal << "\n";
	  	cout << "    PORCENTAJE :" << porcentajeTotal<< "\n";
	  	cout << "    NUMERO DE REGLAS : " <<  numReglasTotal << "\n";
	}else{
